...
const NavigationBar = () => {
  ...
  return (
    <div className={`${isSticky ? "sticky" : ""} top-0  bg-primary z-999  `}>
      <div
        className={`navigation-bar-wrapper flex items-center text-center align-middle  justify-center  gap-x-10 my-10 border-gray-400 border-b-[1px] h-[60px] w-[90vw] mx-auto text-[13px]`}
      >
        <NavigationItem>Amanoi</NavigationItem>
